...
public final class ArrayUtilities {
	...
	/**
	 * Similar to {@link java.util.Arrays#asList(Object[])} but returns a mutable data structure.
	 *
	...
	/**
	 * Wrapper for {@link java.lang.reflect.Array#newInstance(Class, int...)} with a less fucked up signature. Type-inference and generics!
