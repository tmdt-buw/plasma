...
public final class StringUtilities {
	...
	/**
	 * Returns an enumeration string for the given number. E.g. `5` return `5th`. If {@code startCountingWithZero} is true `0` is translated to `1st` and `9` to `8th`.
	 * If the number is not positive and startCountingWithZero is false or number is negative and startCountingWithZero is true the method throws an {@link IllegalArgumentException}.
	 *
	 * @param number                the number to convert
	...
	/**
	 * Returns the result of {@code o.toString()} iff o is not null, {@code null} otherwise. This avoids creating {@code "null"} literals (which {@link String#valueOf(Object)} does).
	 *
