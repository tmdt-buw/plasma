...
import de.buw.tmdt.plasma.services.sas.core.repository.RelationConceptPropertyRepository;
import de.buw.tmdt.plasma.services.sas.core.initializer.StorageInitializer;
...
public class RelationConcept extends TraversableModelBase {
    ...
    public RelationConcept(
        ...
        super(position, id, computeIdentity(id, uuid));
        this.uuid = uuid;
        this.name = name;
