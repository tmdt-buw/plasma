...
public abstract class TraversableModelBase extends ModelBase implements Traversable {
	...
	protected TraversableModelBase(@Nullable Position position, @NotNull Identity<?> identity) {
		super(null);
		this.position = position;
		this.identity = identity;
	}

	protected TraversableModelBase(@Nullable Position position, @Nullable Long id, @NotNull Identity<?> identity) {
		super(id);
		this.position = position;
		this.identity = identity;
	}
